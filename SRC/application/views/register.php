    ...
    <div class="ct-mediaSection-inner">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <?php echo form_open('reg_val', array('role' => 'form', 'class' => 'ct-formRegister pull-right')); ?>
                        <div class="form-group">
                            ...
                            <div class="ct-form--item ct-u-marginBottom20">
                                ...
                                <input name="fullname" type="text" required class="form-control input-lg" placeholder="">
                            </div>
                            <div class="ct-form--item ct-u-marginBottom20">
                                <label>Email</label>
                            ...
                            <div class="ct-form--item ct-u-marginBottom20">
                                ...
                                <input name="repsw" type="password" required class="form-control input-lg" placeholder="">
                            </div>
                            <!--<div class="ct-form--item ct-u-marginBottom20">
                            ...
                            <div class="ct-form--item ct-u-marginBottom20">
                                <div class="checkbox">
                                    <label>
                                        ...
                                        Ho letto e accetto i <a href="terms.html"> termini & le condizioni</a>
                                    </label>
                                </div>
                            </div>
                            <div class="ct-form--item">
                                <button type="submit" class="btn btn-warning center-block">Completa</button>
                            </div>
                        </div>
                    <?php echo form_close(); ?>
                </div>
